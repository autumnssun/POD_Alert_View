...
public class NN_Action_Button:IconButton{
    ...
    public init(title: String,
        ...
        self.titleColor = NN_Pop_Up_Manager.shared.style.colors.buttonTextColorDark
        ...
        case .forceLeftToRight:
            self.titleEdgeInsets = UIEdgeInsets(top: 0,
                                                left: NN_Pop_Up_Manager.shared.style.sizes.boxPadding + (imageView?.frame.width)!,
                                                bottom: 0,
                                                right: 0)
            break
        case .forceRightToLeft:
            self.titleEdgeInsets = UIEdgeInsets(top: 0,
                                                left: 0,
                                                bottom: 0,
                                                right: NN_Pop_Up_Manager.shared.style.sizes.boxPadding+(imageView?.frame.width)!)
            break
        default:
