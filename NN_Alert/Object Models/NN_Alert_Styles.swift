...
public struct NN_Styles{
    ...
    public struct NN_Alerts_Sizes{
        ...
        var actionSheetRowHeight:CGFloat
        public init(padding:CGFloat? = 16, boxPadding:CGFloat? = 5, actionSheetRowHeight:CGFloat? = 40){
            self.paddings = padding!
            self.boxPadding = boxPadding!
            self.actionSheetRowHeight = actionSheetRowHeight!
        }
    }
