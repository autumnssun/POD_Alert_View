...
public class Step:UIStackView{
    ...
    public func changeStatus(status:StepStatus,updatedLabel:String? = nil){
        ...
        switch status {
        case .queing:
            self.image?.image = UIImage.fromWrappedBundleImage(#imageLiteral(resourceName: "empty"))
            self.label?.textColor = UIColor.colbb
            break
        case .working:
            self.image?.image = UIImage.fromWrappedBundleImage(#imageLiteral(resourceName: "loading"))
            ...
            break
        case .success:
            self.image?.image = UIImage.fromWrappedBundleImage(#imageLiteral(resourceName: "success"))
            self.label?.textColor = UIColor.col33
            if let newText = updatedLabel{
                label?.text = newText
            }
            ...
            break
        case .fail:
            self.image?.image = UIImage.fromWrappedBundleImage(#imageLiteral(resourceName: "error"))
            self.label?.textColor = UIColor.col33
            if let newText = updatedLabel{
                label?.text = newText
            }
